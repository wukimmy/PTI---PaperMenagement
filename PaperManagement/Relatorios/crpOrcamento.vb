...
Public Class crpOrcamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PaperManagement.crpOrcamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpOrcamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpOrcamento = New crpOrcamento()
        rpt.Site = Me.Site
        Return rpt
    End Function
