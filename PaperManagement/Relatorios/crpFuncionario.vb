...
Public Class crpFuncionario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PaperManagement.crpFuncionario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpFuncionario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpFuncionario = New crpFuncionario()
        rpt.Site = Me.Site
        Return rpt
    End Function
