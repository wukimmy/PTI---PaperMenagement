...
Public Class crpGraficoDespesa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PaperManagement.crpGraficoDespesa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpGraficoDespesa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpGraficoDespesa = New crpGraficoDespesa()
        rpt.Site = Me.Site
        Return rpt
    End Function
