Public Class frmCadFamilia
    Dim novo As Boolean
    Dim objctl As New clsControle
    Dim objfami As New clsFamilia
    Dim linhaselecionada As Integer
    Dim dataSource As DataTable

    Private Sub frmCadFamilia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnExcluir_Click(sender As Object, e As EventArgs) Handles btnExcluir.Click
        If objfami.Excluir(txtCod.Text) Then
            objctl.LimparTela(Me)
            btnExcluir.Enabled = False
            btnEditar.Enabled = False
        End If
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        If txtLoc.Text = "" Then
            ...
            txtLoc.Focus()
        Else
            dataSource = objfami.localizar(txtLoc.Text)
            dtGrid.DataSource = dataSource
            txtLoc.Text = ""
            If dtGrid.RowCount = 0 Then
                MessageBox.Show("Família Inexistente", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                txtLoc.Focus()
            End If
        End If
    End Sub
    ...
    Private Sub btnCancelar_Click(sender As Object, e As EventArgs) Handles btnCancelar.Click
        Call frmCadFamilia_Load(Nothing, Nothing)
    End Sub
    ...
    Private Sub btnGravar_Click(sender As Object, e As EventArgs) Handles btnGravar.Click
        ...
        objctl.habilitarBotoes(Me, False)
        If novo = False Then
            txtCod.Text = objfami.codigo.ToString
        End If
        objfami.descricao = txtDesc.Text
        objfami.Gravar(novo)
        MessageBox.Show("Família Gravado com Sucesso!")
    End Sub
    ...
    Private Sub dtGrid_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dtGrid.CellDoubleClick
        If MessageBox.Show("Deseja editar ?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ...
            Me.txtDesc.Text = dtGrid.Rows(linhaselecionada).Cells(1).Value
